...
<p align="center">
  Swap a Windows accessibility binary (<code>Magnify.exe</code>, <code>sethc.exe</code>, <code>Utilman.exe</code>, ...) for <code>cmd.exe</code> inside a VirtualBox <code>.vdi</code> disk to get a <code>SYSTEM</code> command prompt from the login screen.
  <br>
